...
export const POST = withApiAuth(async (req, session) => {
  ...
  const systemPrompt = [
    ...
    "the Amana Way, Employee Handbook, Proven Process, ALL QA1–QA7",
    "policies and procedures, company-wide SOPs, staff help articles,",
    ...
    "escalation paths, policy wording). At the end of your answer,",
    "include a 'Read the full doc:' line listing the link(s) you used.",
    "If a search result has NO OpenUrl (a pasted-text entry), just",
    "name the document without a link.",
    "",
