...
export const ENROL_TRANSLATIONS_SOURCE: Record<string, LocaleDict> = {
  ar: {
    ...
    "child.firstName": "الاسم الأول",
    "child.surname": "اسم العائلة",
    "child.dob": "تاريخ الميلاد",
    "child.gender": "الجنس",
    "child.countryOfBirth": "بلد الميلاد",
    "child.section.address": "العنوان",
    "child.street": "الشارع",
    "child.suburb": "الضاحية",
    "child.state": "الولاية",
    "child.postcode": "الرمز البريدي",
    "child.section.school": "المدرسة",
    "child.school": "المدرسة",
    "child.class": "الصف",
    "child.culturalBackground": "الخلفية الثقافية / اللغوية",
    "common.select": "اختر...",
    "common.other": "أخرى",
  },
  ...
  ur: {
    ...
    "child.firstName": "پہلا نام",
    "child.surname": "خاندانی نام",
    "child.dob": "تاریخ پیدائش",
    "child.gender": "جنس",
    "child.countryOfBirth": "ملکِ پیدائش",
    "child.section.address": "پتہ",
    "child.street": "گلی",
    "child.suburb": "علاقہ",
    "child.state": "ریاست",
    "child.postcode": "پوسٹ کوڈ",
    "child.section.school": "اسکول",
    "child.school": "اسکول",
    "child.class": "جماعت",
    "child.culturalBackground": "ثقافتی / لسانی پس منظر",
  ...
  so: {
    ...
    "child.firstName": "Magaca Hore",
    "child.surname": "Magaca Qoyska",
    "child.dob": "Taariikhda Dhalashada",
    "child.gender": "Jinsiga",
    "child.countryOfBirth": "Dalka Dhalashada",
    "child.section.address": "Cinwaanka",
    "child.street": "Waddada",
    "child.suburb": "Xaafadda",
    "child.state": "Gobolka",
    "child.postcode": "Lambarka Boostada",
    "child.section.school": "Iskuulka",
    "child.school": "Iskuulka",
    "child.class": "Fasalka",
    "child.culturalBackground": "Asalka Dhaqanka / Luqadda",
    "common.select": "Dooro...",
    "common.other": "Kale",
  },
  ...
  ps: {
    ...
    "child.firstName": "لومړی نوم",
    "child.surname": "تخلص",
    "child.dob": "د زیږون نېټه",
    "child.gender": "جنسیت",
    "child.countryOfBirth": "د زیږون هېواد",
    "child.section.address": "پته",
    "child.street": "کوڅه",
    "child.suburb": "سیمه",
    "child.state": "ایالت",
    "child.postcode": "پوستي کوډ",
    "child.section.school": "ښوونځی",
    "child.school": "ښوونځی",
    "child.class": "ټولګی",
    "child.culturalBackground": "کلتوري / ژبنۍ شاليد",
    "common.select": "وټاکئ...",
    "common.other": "نور",
  },
  ...
  tr: {
    ...
    "child.firstName": "Ad",
    "child.surname": "Soyad",
    "child.dob": "Doğum Tarihi",
    "child.gender": "Cinsiyet",
    "child.countryOfBirth": "Doğum Ülkesi",
    "child.section.address": "Adres",
    "child.street": "Sokak",
    "child.suburb": "Semt",
    "child.state": "Eyalet",
    "child.postcode": "Posta Kodu",
    "child.section.school": "Okul",
    "child.school": "Okul",
    "child.class": "Sınıf",
    "child.culturalBackground": "Kültürel / Dil Geçmişi",
