      ...
      <ContentBlock title="Team Structure">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="bg-teal-700 text-white rounded-lg p-4">
            <div className="text-xs font-bold tracking-wider text-brand-yellow uppercase mb-2">Director of Service</div>
    ...
    <>
      ...
      <ContentBlock title="Authorisation to Collect">
        <Checklist items={[
          ...
          "If a parent/carer appears impaired, <strong>do not release the child</strong> - contact Director of Service immediately",
...
function PoliciesSection() {
  const policies = [
    ...
    { n: 9, t: "Administration of First Aid Policy", d: "Sets out how first aid is to be administered and recorded.", items: ["Maintain current First Aid, CPR and Anaphylaxis management certificates", "Administer first aid promptly and within limits of your training", "Record every first aid event in OWNA immediately", "Notify the Director of Service of all first aid events on the day", "Never administer unauthorised medication"] },
    { n: 10, t: "Privacy and Confidentiality Policy", d: "Protects the personal and sensitive information of children, families and staff.", items: ["Never share personal information with unauthorised people", "Do not photograph children without prior parental consent on file", "Keep physical records secure and digital records password protected", "If aware of a privacy breach, notify the Director of Service immediately", "Access only the information you need to do your job"] },
    { n: 11, t: "Safe Arrival of Children Policy", d: "Ensures every child's arrival is confirmed and tracked.", items: ["Mark every child present in OWNA as soon as they arrive", "If a booked child does not arrive, contact the family within 15 minutes", "Escalate to the Director of Service if a child cannot be accounted for", "Record any safe-arrival call or action taken in OWNA", "Never assume a child is absent without confirmation"] },
    { n: 12, t: "Safe Use of Digital Technologies Policy", d: "Guides safe, ethical and age-appropriate use of digital devices.", items: ["Supervise children's use of devices and internet at all times", "Only use approved, age-appropriate digital resources", "Do not use your personal mobile phone during supervision", "Report any concerning online behaviour to the Director of Service", "Never allow children to access social media or unfiltered internet"] },
    { n: 13, t: "Sick Leave Policy", d: "Outlines entitlements and process for taking personal/sick leave.", items: ["Notify your Director of Service as early as possible if you are unwell", "Do not attend work if you have a contagious illness", "Provide a medical certificate for 3+ consecutive days", "Advise families not to bring unwell children; follow exclusion period guidelines", "Record your leave accurately through the OWNA staff module"] },
