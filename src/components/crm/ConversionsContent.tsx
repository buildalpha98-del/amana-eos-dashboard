...
export function ConversionsContent() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-foreground">Casual → Regular Conversions</h2>
        <p className="text-sm text-muted mt-0.5">Identify and convert repeat casual families to regular bookings</p>
      </div>
