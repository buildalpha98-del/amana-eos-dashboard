          ...
          <div className="px-5 py-4 bg-brand/[0.02] space-y-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="text-xs px-3 py-1.5 bg-brand text-white rounded-md hover:bg-brand-hover disabled:opacity-50"
              >
          ...
          {goal.rocks.length > 0 && (
            <div className="space-y-1">
              ...
              {goal.rocks.map((rock) => (
                <div
                  key={rock.id}
                  className="flex items-center gap-2 px-2 py-1 bg-brand/5 rounded"
                >
                  <Mountain className="w-3 h-3 text-brand" />
