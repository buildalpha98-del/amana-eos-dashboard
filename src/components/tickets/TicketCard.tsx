...
const priorityConfig = {
  ...
  normal: { label: "Normal", icon: Minus, color: "text-blue-600", bg: "bg-white", badge: "bg-blue-100 text-blue-700 border-blue-200" },
  low: { label: "Low", icon: ArrowDown, color: "text-gray-500", bg: "bg-white", badge: "bg-gray-100 text-gray-600 border-gray-200" },
};
...
const statusConfig = {
  ...
  closed: { label: "Closed", color: "text-gray-400", bg: "bg-gray-50", dot: "bg-gray-400" },
};
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-500 mt-1 truncate">
            ...
            {ticket.contact.childName && (
              <span className="text-gray-400"> ({ticket.contact.childName})</span>
            )}
          </p>
