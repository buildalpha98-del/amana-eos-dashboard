          ...
          <div key={section.type} className="space-y-3">
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          seq.isActive ? "bg-brand" : "bg-gray-200",
                        )}
                      >
                        <span
                          className={cn(
            ...
            {sectionSequences.length === 0 && (
              <button
                onClick={handleSeed}
                disabled={seeding}
                className="inline-flex items-center gap-2 rounded-lg border border-border bg-white px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-surface disabled:opacity-50"
              >
